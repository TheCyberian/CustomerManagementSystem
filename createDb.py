...
c.execute("DROP TABLE IF EXISTS itemDetails")
...
c.execute(
    "INSERT INTO customer(name, initial, address1, address2, address3, pincode, phone1, phone2, email) VALUES ('TestName', 'Mr.', 'AddressTest1', 'AddressTest2', 'AddressTest3'"
...
c.execute("CREATE TABLE IF NOT EXISTS orderDetails(orderId INTEGER PRIMARY KEY, custId INTEGER, itemNumber INTEGER, "
          "amountPaid INTEGER, weight INTEGER, totalAmount INTEGER,"
...
c.execute("INSERT INTO itemDetails(itemName) VALUES ('TestItemName1')")
c.execute("INSERT INTO itemDetails(itemName) VALUES ('TestItemName2')")
c.execute("INSERT INTO itemDetails(itemName) VALUES ('TestItemName3')")

# #inserting data to orderDetails table
c.execute("INSERT INTO orderDetails(custId, itemNumber, amountPaid, weight, totalAmount) VALUES (2, 2, 105, 40, 145)")
c.execute("INSERT INTO orderDetails(custId, itemNumber, amountPaid, weight, totalAmount) VALUES (2, 3, 110, 24, 134)")
c.execute("INSERT INTO orderDetails(custId, itemNumber, amountPaid, weight, totalAmount) VALUES (1, 3, 111, 10, 121)")
